      ...
      <ul class="nav tab_nav unordered_list_center" role="tablist">
        <li role="presentation">
          <button class="active" data-bs-toggle="tab" data-bs-target="#tab_cooling_system" type="button" role="tab" aria-selected="true">
            <span class="btn_icon">
              <img src="{{ asset('assets/images/icons/icon_oil.svg') }}" alt="ProMotors - Cooling System Icon">
            </span>
            <span class="btn_text">
              Cooling System
            </span>
        ...
        <li role="presentation">
          <button data-bs-toggle="tab" data-bs-target="#tab_tire_repair" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="{{ asset('assets/images/icons/icone_tire.svg') }}" alt="ProMotors - Tire Repair Icon">
            </span>
            <span class="btn_text">
              Tire Repair
            </span>
        ...
        <li role="presentation">
          <button data-bs-toggle="tab" data-bs-target="#tab_steering_repair" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="{{ asset('assets/images/icons/icon_break.svg') }}" alt="ProMotors - Steering Repair Icon">
            </span>
            <span class="btn_text">
              Steering Repair
            </span>
        ...
        <li role="presentation">
          <button data-bs-toggle="tab" data-bs-target="#Tab_engine_repair" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="{{ asset('assets/images/icons/icon_steering.svg') }}" alt="ProMotors - Engine Repair Icon">
            </span>
            <span class="btn_text">
              Engine Repair
            </span>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="item_image">
                <img src="{{ asset('assets/images/products/tab_image_1.png') }}" alt="ProMotors - Tire Image">
              </div>
            </div>
          </div>
        </div>
