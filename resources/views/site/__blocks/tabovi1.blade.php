<section class="about_section section_space_lg pb-0">
    <div class="container">
      ...
      <ul class="nav tab_nav unordered_list_center" role="tablist">
        ...
        <li role="presentation" class="service_tab">
          <button class="active" data-bs-toggle="tab" data-bs-target="#service_tab_1" type="button" role="tab" aria-selected="true">
            <span class="btn_icon">
              <img src="assets/images/icons/icon_lever.svg" alt="">
            </span>
            <span class="btn_text">
              MOT's
            </span>
        ...
        <li role="presentation" class="service_tab">
          <button data-bs-toggle="tab" data-bs-target="#service_tab_2" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="assets/images/icons/icon_engine_2.svg" alt="">
            </span>
            <span class="btn_text">
              Servicing
            </span>
        ...
        <li role="presentation" class="service_tab">
          <button data-bs-toggle="tab" data-bs-target="#service_tab_3" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="assets/images/icons/icon_oil.svg" alt="">
            </span>
            <span class="btn_text">
              Repairs
            </span>
        ...
        <li role="presentation" class="service_tab">
          <button data-bs-toggle="tab" data-bs-target="#service_tab_4" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="assets/images/icons/icone_tire.svg" alt="">
            </span>
            <span class="btn_text">
              Mobile Tyre Fitting
            </span>
        ...
        <li role="presentation" class="service_tab">
          <button data-bs-toggle="tab" data-bs-target="#service_tab_5" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="assets/images/icons/icon_gear.svg" alt="">
            </span>
            <span class="btn_text">
              Parts Sourcing
            </span>
        ...
        <li role="presentation" class="service_tab">
          <button data-bs-toggle="tab" data-bs-target="#service_tab_6" type="button" role="tab" aria-selected="false">
            <span class="btn_icon">
              <img src="assets/images/icons/icon_battery.svg" alt="">
            </span>
            <span class="btn_text">
              Vehicle Recovery
            </span>
      ...
      <div class="tab-content" style="position: relative"><!--  style="background-image: url('assets/images/shapes/tyre_print_5.svg');" -->
          ...
          <div class="row align-items-center">
            <div class="col-lg-12" style="position: relative">
              ...
              <div class="item_image">
                <img src="assets/images/services_tabs/1.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="service_tab_2" role="tabpanel">
          <div class="row align-items-center">
            <div class="col-lg-12" style="position: relative">
              ...
              <div class="item_image">
                <img src="assets/images/services_tabs/2.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="service_tab_3" role="tabpanel">
          <div class="row align-items-center">
            <div class="col-lg-12" style="position: relative">
              ...
              <div class="item_image">
                <img src="assets/images/services_tabs/3.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="service_tab_4" role="tabpanel">
          <div class="row align-items-center">
            <div class="col-lg-12" style="position: relative">
              ...
              <div class="item_image">
                <img src="assets/images/services_tabs/4.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="service_tab_5" role="tabpanel">
          <div class="row align-items-center">
            <div class="col-lg-12" style="position: relative">
              ...
              <div class="item_image">
                <img src="assets/images/services_tabs/5.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="service_tab_6" role="tabpanel">
          <div class="row align-items-center">
            <div class="col-lg-12" style="position: relative">
              ...
              <div class="item_image">
                <img src="assets/images/services_tabs/6.jpg" alt="">
              </div>
            </div>
          </div>
        </div>
