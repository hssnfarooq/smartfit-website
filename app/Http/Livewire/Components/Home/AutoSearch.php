...
class AutoSearch extends Component
{
    ...
    public function searchReg(){
        if(empty($this->registration)) return redirect()->to('/booking/order');
        $this->validate();
        $dvsa = new Dvsa();
